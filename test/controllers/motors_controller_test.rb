...
class MotorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create motor" do
    assert_difference("Motor.count") do
      post motors_url, params: { motor: { description: @motor.description, nombre: @motor.nombre, tipo_equipo: @motor.tipo_equipo, user_id: @motor.user_id } }
    end
  ...
  test "should update motor" do
    patch motor_url(@motor), params: { motor: { description: @motor.description, nombre: @motor.nombre, tipo_equipo: @motor.tipo_equipo, user_id: @motor.user_id } }
